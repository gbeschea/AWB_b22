...
const STR: Record<string, { en?: string; ro: string }> = {
  // ── Gardă de stoc ──
  "Stock guard": { ro: "Gardă de stoc" },
  "On": { ro: "Pornite" },
  "Off": { ro: "Oprite" },
  "Check now": { ro: "Verifică acum" },
  "SMTP isn't configured on the server — alerts can't be sent.":
    { ro: "SMTP nu e configurat pe server — alertele nu pot pleca." },
  "Couldn't load settings": { ro: "Nu s-au putut încărca setările" },
  "Loading…": { ro: "Se încarcă…" },
  "Default": { ro: "Implicit" },
  "alert below": { ro: "alertează sub" },
  "units": { ro: "buc" },
  "send to": { ro: "trimite la" },
  "no recipients": { ro: "fără destinatari" },
  "Done": { ro: "Gata" },
  "Alerts": { ro: "Alerte" },
  "Alert below": { ro: "Alertează sub" },
  "Send to": { ro: "Trimite la" },
  "Re-arm margin": { ro: "Marjă de re-armare" },
  "New alert only after stock climbs back above the threshold plus this margin.":
    { ro: "Alertă nouă doar după ce stocul urcă peste prag + marja asta." },
  "Exceptions": { ro: "Excepții" },
  "Groups": { ro: "Grupuri" },
  "No exceptions — every product uses the default rule.":
    { ro: "Nicio excepție — toate produsele merg pe regula implicită." },
  "They replace the default rule for what they cover — a product never shows up twice. If several match: store beats group, group beats total.":
    { ro: "Înlocuiesc regula implicită pentru ce acoperă — un produs nu apare de două ori. Dacă se potrivesc mai multe: magazin înaintea grupului, grupul înaintea totalului." },
  "Whole group": { ro: "Tot grupul" },
  "all products": { ro: "toate produsele" },
  "products": { ro: "produse" },
  "no alerts": { ro: "fără alerte" },
  "below": { ro: "sub" },
  "and": { ro: "și" },
  "without": { ro: "fără" },
  "Applies to": { ro: "Se aplică la" },
  "This store's stock.": { ro: "Stocul acestui magazin." },
  "The sum of the stores in the group.": { ro: "Suma magazinelor din grup." },
  "Total stock across the group.": { ro: "Stocul total din grup." },
  "Products (SKU)": { ro: "Produse (SKU)" },
  "all, if empty": { ro: "toate, dacă e gol" },
  "Paste as many as you like, comma-separated.":
    { ro: "Lipește oricâte, separate prin virgulă." },
  "Action": { ro: "Ce facem" },
  "Alert below…": { ro: "Alertează sub…" },
  "Never alert": { ro: "Nu alerta deloc" },
  "Threshold": { ro: "Prag" },
  "Recipients": { ro: "Destinatari" },
  "Excluded": { ro: "Excluși" },
  "Even if they are in the default list.": { ro: "Chiar dacă e în lista implicită." },
  "Store groups": { ro: "Grupuri de magazine" },
  "One exception for several stores at once. The group's stock is their sum.":
    { ro: "O singură excepție pentru mai multe magazine. Stocul grupului = suma lor." },
  "Add group": { ro: "Adaugă grup" },
  "(unnamed)": { ro: "(fără nume)" },
  "stores": { ro: "magazine" },
  "no stores": { ro: "niciun magazin" },
  "Name": { ro: "Nume" },
  "Only these products (SKU)": { ro: "Doar produsele (SKU)" },
  "Stores in group": { ro: "Magazine în grup" },
  "Stock guard settings saved.": { ro: "Setările gărzii de stoc au fost salvate." },
  "Couldn't save": { ro: "Nu s-a putut salva" },
  "Run failed": { ro: "Rulare eșuată" },
  "Baseline": { ro: "Linie de bază" },
  "products already below threshold, recorded without email.":
    { ro: "produse deja sub prag, înregistrate fără email." },
  "checked": { ro: "verificate" },
  "below threshold": { ro: "sub prag" },
  "new alerts": { ro: "alerte noi" },
  // ── Orders: lens tabs ──
